...
unique_objects = [
    {'primitive': 'Parallelogram', 'colour': 9, 'id': 0, 'actual_pixels_id': 0, 'dimensions': Dimension2D(2, 2),
     ...
     'in_out_transformations': [[['translate_by', [0, 0]]]],
     'symmetries': []},
    {'primitive': 'Parallelogram', 'colour': 9, 'id': 0, 'actual_pixels_id': 0, 'dimensions': Dimension2D(2, 2),
    ...
    {'primitive': 'Random', 'colour': 3, 'id': 1, 'actual_pixels_id': 1, 'dimensions': Dimension2D(4, 3),
     ...
     'on_canvas_transformations': [],
     'in_out_transformations': [[['translate_along', ['Down', 6, [3, 10]]]]],
     'symmetries': []},
    {'primitive': 'Random', 'colour': 3, 'id': 1, 'actual_pixels_id': 2, 'dimensions': Dimension2D(3, 4),
     'canvas_and_position': [2, Point(0, 4, 0)],
     'actual_pixels': task.get_object_pixels_from_data(2, Point(0, 4, 0), Dimension2D(3, 4)),
     'on_canvas_transformations': [],
     'in_out_transformations':  [[['translate_along', ['Right', 3, [2, 4]]]]],
     'symmetries': []},
    {'primitive': 'Random', 'colour': 3, 'id': 1, 'actual_pixels_id': 3, 'dimensions': Dimension2D(5, 3),
     'canvas_and_position': [4, Point(1, 2, 0)],
     'actual_pixels': task.get_object_pixels_from_data(4, Point(1, 2, 0), Dimension2D(5, 3)),
     'on_canvas_transformations': [],
     'in_out_transformations': [[['translate_along', ['Up', 3, [3, 4]]]]],
     'symmetries': []},
    {'primitive': 'Random', 'colour': 3, 'id': 1, 'actual_pixels_id': 4, 'dimensions': Dimension2D(2, 4),
     'canvas_and_position': [6, Point(5, 3, 0)],
     'actual_pixels': task.get_object_pixels_from_data(6, Point(5, 3, 0), Dimension2D(2, 4)),
     'on_canvas_transformations': [],
     'in_out_transformations': [[['translate_along', ['Left', 2, [5, 4]]]]],
     'symmetries': []},
    ]

task.generate_objects_from_description(unique_objects=unique_objects)
