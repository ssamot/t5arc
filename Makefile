...
data:
	CUDA_VISIBLE_DEVICES="" PYTHONPATH=./src $(PYTHON_INTERPRETER) src/data/create_ds.py data/raw/arc_original/training data/processed/train data/processed/train.npz 1000
